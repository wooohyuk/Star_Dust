...
namespace Shake
{
    ...
    public class ShakeInstance
    {
        ...
        public ShakeInstance(float magnitude, float roughness, float fadeInTime, float fadeOutTime) : this(fadeInTime, fadeOutTime)
        {
            this.Magnitude = magnitude;
            this.Roughness = roughness;
        }

        public ShakeInstance(float fadeInTime, float fadeOutTime) : this()
        {
